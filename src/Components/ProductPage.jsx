...
const ProductPage = () => {
    ...
    const getProduct = async () => {
        const data1 = await fetch(`https://fakestoreapi.com/products/${id}`)
                            ...
                            <div className="container px-5 py-24 mx-auto">
                                <div className="lg:w-4/5 mx-auto flex flex-wrap">
                                    ...
                                    <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                                        <h2 className="text-sm title-font text-gray-500 tracking-widest">{data.name}</h2>
                                        ...
                                        <div className="flex">
                                            ...
                                            <button className="flex ml-auto text-white bg-blue-700 border-0 py-2 px-6 focus:outline-none hover:bg-blue-800 rounded" onClick={() => contextData.addToCart(data)}>Add To Cart</button>
