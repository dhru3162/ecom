...
const RagisterDetails = () => {
    ...
    const emaildata = () => {
        if (ifmobile === null) {
            // fetch(`https://64cc9ddf2eafdcdc851a0938.mockapi.io/EcomLogin?email=${email}`)
            //     .then((res) => {
            //         return res.json()
            //             .then((data) => {
            //                 console.log(data[0])
            //                 setmobilemaile(data[0])
            //                 setuserdata(data[0])
            //             })
            //     })
            //     .catch((err) => {
            ...
            // fetch(`https://64cc9ddf2eafdcdc851a0938.mockapi.io/EcomLogin?mobile=${ifmobile}`)
            //     .then((res) => {
            //         return res.json()
            //             .then((data) => {
            //                 console.log(data[0])
